    ...
    return (
        <div id="aboutPageContainer">
            <div id="aboutContentsContainer">
                ...
                <p>Thank you for choosing AI Snack Mate — where your kitchen adventure begins!</p>
            </div>
        </div>
    );
}