...
export default function HomePage() {
  return (
    <div id="homeContainer">
      ...
      <p id="homeDescription">Discover the joy of cooking with our powerfull recipe generator. Enter any dish, and we'll provide a delicious recipe tailored just for you!</p>
      <div id="homeImages">
